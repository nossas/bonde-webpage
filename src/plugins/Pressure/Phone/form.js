...
class PressureForm extends React.Component {
  ...
  componentWillReceiveProps(props) {
    ...
    if (
      ...
      props.targetList &&
      props.targetList.length &&
      JSON.stringify(this.props.callTransition) !==
        JSON.stringify(props.callTransition)
    ) {
      this.setState({
        callManagement: this.state.callManagement.map((target, index) => {
          const isCallToCurrentTarget =
            target.value === props.callTransition.twilioCallTo;
    ...
    if (this.state.pressureType === pressureUtils.PRESSURE_TYPE_EMAIL) {
      if (!this.state.email) {
        ...
        errors.email = intl.formatMessage({
          id:
            'pressure-widget.components--pressure-form.email.validation.invalid-email-format',
          defaultMessage: 'E-mail inválido',
        });
      } else if (
        targetList &&
        targetList.some(target => target.match(`<${this.state.email}>`))
      ) {
        errors.email = intl.formatMessage({
          id:
            'pressure-widget.components--pressure-form.email.validation.sender-is-target',
          defaultMessage:
      ...
      if (!phone) {
        ...
        if ([11, 12].includes(phoneE164.length)) {
          errors.phone = intl.formatMessage({
            id:
              'pressure-widget.components--pressure-form.phone.validation.ddd',
            defaultMessage:
          ...
          errors.phone = intl.formatMessage({
            id:
              'pressure-widget.components--pressure-form.phone.validation.invalid',
        ...
        errors.phone = intl.formatMessage({
          id:
            'pressure-widget.components--pressure-form.phone.validation.caller-is-target',
          defaultMessage:
  ...
  render() {
    ...
    return (
      <form
        className={classnames('pressure-form', {
      ...
      >
        ...
        >
          <div className="form bg-white rounded-bottom">
            {this.state.pressureType === 'email' && (
              <div className={classnames('form-group', controlClassname)}>
                ...
                <input
                  ...
                  className="col-12"
                  style={inputReset}
                  onBlur={this.props.analyticsEvents.pressureIsFilled.bind(
                    this.props.analyticsEvents
                  )}
                  type="email"
                  placeholder={intl.formatMessage({
                    id:
                      'pressure-widget.components--pressure-form.email.placeholder',
            ...
            {this.state.pressureType === 'phone' && (
              <div className={classnames('form-group', controlClassname)}>
                ...
                <input
                  ...
                  placeholder={intl.formatMessage({
                    id:
                      'pressure-widget.components--pressure-form.phone.placeholder',
            ...
            <div className={classnames('form-group', controlClassname)}>
              <label
                className="py1 gray"
                htmlFor="pressure-sender-firstname-id"
              >
                <FormattedMessage
              ...
              <input
                ...
                placeholder={intl.formatMessage({
                  id:
                    'pressure-widget.components--pressure-form.name.placeholder',
            ...
            <div className={classnames('form-group', controlClassname)}>
              ...
              <input
                ...
                placeholder={intl.formatMessage({
                  id:
                    'pressure-widget.components--pressure-form.lastname.placeholder',
            ...
            {!widget.settings.show_city ||
            widget.settings.show_city !== 'city-true' ? null : (
              <div className={classnames('form-group', controlClassname)}>
                ...
                <input
                  ...
                  placeholder={intl.formatMessage({
                    id:
                      'pressure-widget.components--pressure-form.city.placeholder',
        ...
        {this.state.pressureType === 'phone' && (
          <div className="phone-calls">
            <ul>
              {callManagement &&
                callManagement.length &&
                callManagement.map((target, i) => {
                  const {
                    name,
                    value,
                    attempts,
                  ...
                  if (to === value) {
                    if (status === 'completed') {
                      ...
                      ['busy', 'failed', 'no-answer'].includes(status)
                    ) {
                      ListItem = (
                        ...
                        ListItem = (
                          <li className="danger" key={componentKey}>
                            <div className="flex-container">
                              ...
                              <div className="inline-container">
                                <div className="prefix">{attempts}x</div>
                                <button
                                  ...
                                  onClick={e => {
                                    ...
                                    addTwilioCallMutation({
                                      ...
                                      communityId: this.props.mobilization
                                        .community_id,
