...
import formEntry, { Args, formEntryQuery, fill_activist } from './form-entry';
...
describe('activists module form entry tests', () => {
  ...
  it('should be pattern to get name and first_name', () => {
    ...
    expect(fill_activist([email, name])).toEqual({
      first_name: name.value,
      name: name.value,
      email: email.value
    });

    expect(fill_activist([email, {...name, label: 'Nome'}])).toEqual({
      first_name: name.value,
      name: name.value,
      email: email.value
    });

    expect(fill_activist([email, { ...name, label: 'Nombre' }])).toEqual({
      first_name: name.value,
      name: name.value,
      email: email.value
    });

    expect(fill_activist([email, { ...name, label: 'Firstname' }])).toEqual({
      first_name: name.value,
      name: name.value,
      email: email.value
    });

    expect(fill_activist([email, { ...name, label: 'First-name' }])).toEqual({
      first_name: name.value,
      name: name.value,
      email: email.value
    });
  ...
  it('should be pattern to get name and last_name', () => {
    ...
    expect(fill_activist([email, name, lastName])).toEqual({
      first_name: name.value,
    ...
    expect(fill_activist([email, name, {...lastName, label: 'Surname' }])).toEqual({
      first_name: name.value,
      name: `${name.value} ${lastName.value}`,
      email: email.value,
      last_name: lastName.value
    ...
    expect(fill_activist([email, name, { ...lastName, label: 'Apellido' }])).toEqual({
      first_name: name.value,
      name: `${name.value} ${lastName.value}`,
      email: email.value,
      last_name: lastName.value
    ...
    expect(fill_activist([email, name, { ...lastName, label: 'Sobrenome' }])).toEqual({
      first_name: name.value,
      name: `${name.value} ${lastName.value}`,
      email: email.value,
      last_name: lastName.value
  ...
  it('should be pattern to get email', () => {
    ...
    expect(fill_activist([{...email, label: 'E-mail' }, name])).toEqual({
      first_name: name.value,
      name: name.value,
      email: email.value
    });
  ...
  it('should be pattern to get phone', () => {
    ...
    expect(fill_activist([email, name, phone])).toEqual({
      first_name: name.value,
      name: name.value,
      email: email.value,
      phone: phone.value
    ...
    expect(fill_activist([email, name, {...phone, label: 'mobile'}])).toEqual({
      first_name: name.value,
      name: name.value,
      email: email.value,
      phone: phone.value
    ...
    expect(fill_activist([email, name, { ...phone, label: 'portable' }])).toEqual({
      first_name: name.value,
      name: name.value,
      email: email.value,
      phone: phone.value
  ...
  it('should be pattern to get city', () => {
    ...
    expect(fill_activist([email, name, city])).toEqual({
      first_name: name.value,
      name: name.value,
      email: email.value,
      city: city.value
    ...
    expect(fill_activist([email, name, { ...city, label: 'City' }])).toEqual({
      first_name: name.value,
      name: name.value,
      email: email.value,
      city: city.value
    ...
    expect(fill_activist([email, name, { ...city, label: 'Ciudad' }])).toEqual({
      first_name: name.value,
      name: name.value,
      email: email.value,
      city: city.value
